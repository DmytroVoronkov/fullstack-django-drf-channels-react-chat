...
def server_icon_upload_path(instance: models.Model, filename: str) -> str:
    return f"server/{instance.id}/server_icon/{filename}"

def server_banner_upload_path(instance: models.Model, filename: str) -> str:
    return f"server/{instance.id}/server_banner/{filename}"

def category_icon_upload_path(instance: models.Model, filename: str) -> str:
